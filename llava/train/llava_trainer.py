...
class LLaVATrainer(Trainer):
    ...
    def create_optimizer(self):
        ...
        if self.optimizer is None:
            ...
            if self.args.mm_vision_resampler_lr is not None:
                lr_mapper["resampler"] = self.args.mm_vision_resampler_lr
                lr_mapper['spatial_height_input_embeddings'] = self.args.mm_vision_resampler_lr
                lr_mapper['spatial_width_input_embeddings'] = self.args.mm_vision_resampler_lr
                lr_mapper['spatial_height_output_embeddings'] = self.args.mm_vision_resampler_lr
                lr_mapper['spatial_width_output_embeddings'] = self.args.mm_vision_resampler_lr

                lr_mapper['temporal_input_embeddings'] = self.args.mm_vision_resampler_lr
                lr_mapper['temporal_output_embeddings'] = self.args.mm_vision_resampler_lr
                
                lr_mapper['embed_tokens'] = self.args.mm_vision_resampler_lr
